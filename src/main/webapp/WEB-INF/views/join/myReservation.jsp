 ...
 */
	...
	$.ajax({
		url: '/gurume365/reservation/getMyResList',
		type: 'get',
		dataType: 'json',
		success: function(dat) {
			...
			for(var d of dat) {
				...
				var dateTime = (d.resInfo.datetime).split(' ');
				var html = '<tr id="resRow' + d.seqRes + '">' +
								'<td><a href="../store/shopInfo?shopNo=' + d.resInfo.shopNo + '" class="restd1">' + d.CompanyName + '</a></td>' +
								'<td>' + dateTime[0] + '</td>' +
								'<td>' + dateTime[1] + '</td>' +
								'<td>' + d.resInfo.person + '</td>' +
							'</tr>';
				$('#listBody').append(html);
				if(cnt%2==1) {
					$('#resRow' + d.seqRes).css('background-color', '#ffffff');
				}
				else {
					$('#resRow' + d.seqRes).css('background-color', '#e0e0e0');
				}
...
<body>
	...
	<div class="img">
		<div class="innerImg">
			<img src="<c:url value="/resources/img/back4.jpg"/>">
    ...
    <div class="mainInfo" align="right">
    	...
    	<div class="left">
    		...
    		<div class="middleRight" align="center">
    			...
    			<h2 style="color: white; position: relative; bottom: 15px;">내 예약</h2>
    			</div>
