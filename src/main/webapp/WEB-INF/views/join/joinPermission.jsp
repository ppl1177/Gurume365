...
function permissionCheck(){
	...
	if(check1.checked&&check2.checked){
		...
		$('#hiddenModal').attr('href','join/joinForm');
		$('#hiddenModal').get(0).click();
...
<div id="joinPermission_main">
	...
	<div id="joinPermission_content1">
		<textarea rows="10" cols="47" readonly="readonly">제 1 장 총칙

제 1 조 (목적)

이 약관은 주식회사 Gurume365(이하 회사)이 제공하는 e알리미의 이용과 관련하여 회사와 소속기관, 그리고 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
...
1. 서비스 이용과 관련한 불만사항은 e알리미 서비스 내 고객문의에 등록 또는 gurume365@gmail.com로 메일을 보내주시면 접수하여 처리합니다.

2. 서비스 이용 불만사항의 경우 아래와 같이 처리됩니다.</textarea>
	</div>
	...
	<div id="joinPermission_content2">
		<textarea rows="10" cols="47" readonly="readonly">1.  수집하는 개인정보의 항목 및 수집방법
